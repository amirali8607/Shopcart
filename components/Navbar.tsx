   ...
   return (
      <nav className="flex justify-between text-[#CCC5B9] items-center px-12 py-6">
         ...
         <div>
            {
               user ?
                  <Link className="text-[#2f8a62] transition-all duration-100" href="/shopcart">
                     <svg
                  ...
                  </Link> : <Link href="/signup" className="border border-[#4ba377] text-[#4ba377] text-sm transition-colors font-semibold py-2 rounded-md px-6">Register</Link>
            }
         </div>
      </nav>
   );
